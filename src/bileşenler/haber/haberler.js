...
const haberYapici = (haber) => {
  ...
  par1.textContent = haber.ikinciParagraf;
  card.append(par2);

  const par3 = document.createElement("p");
  par1.textContent = haber.ucuncuParagraf;
  card.append(par3);
  ...
  button.addEventListener("click", (event) => {
    const openbutten = document.querySelector(".article-open");
    if (openbutten && openbutten != button.parentElement) {
      openbutten.classList.remove("article-open");
    }
